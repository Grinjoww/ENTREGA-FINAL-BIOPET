...
class CitaControllerTest {
    ...
    @BeforeEach
    void setUp() {
        // Consultas y citas dependen de mascotas por FK.
        // Deben eliminarse antes que las mascotas.
    ...
    void duenoNoPuedeConsultarCitaDeMascotaAjena() throws Exception {
        ...
        Long citaAjenaId = crearCitaYObtenerId(
                otraMascotaId,
                veterinarioId
        );
    ...
    @Test
    void veterinarioNoPuedeActualizarCitaDeOtroVeterinarioDevuelve403()
            throws Exception {
    ...
    private String cuerpoCita(
            Long mascotaId,
            Long veterinarioId,
            String estado,
            String motivo
    ) {
        String fechaHora = Instant.now()
    ...
    private Long crearCitaYObtenerId(
            Long mascotaId,
            Long veterinarioId
    ) {
