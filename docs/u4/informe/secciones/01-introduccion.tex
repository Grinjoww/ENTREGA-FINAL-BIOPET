...
Lo que resta para esta entrega es la etapa de validaci\'on/compilaci\'on
final del documento (generar el PDF con la cadena de compilaci\'on descrita
en \texttt{docs/u4/informe/README.md} y revisar el resultado), no
contenido acad\'emico todav\'ia sin redactar.
