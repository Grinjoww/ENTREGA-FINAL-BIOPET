...
\begin{itemize}[nosep]
  \item \textbf{Equipo original del PFC BIOPET (equipo BMT):} Mariscal
    ...
    Zaida Melissa. Este equipo dise\~n\'o, implement\'o y documento
...
Esta versi\'on del informe es un \textbf{borrador estructural}, preparado
antes de integrar los aportes de investigaci\'on y revisi\'on cr\'itica de
Carvajal y Fajardo. Los cap\'itulos~\ref{cap:soap-vs-rest}
(SOAP vs REST), \ref{cap:tendencias-web} (tendencias web)
y~\ref{cap:revision-cruzada} (revisi\'on cruzada), as\'i como las
conclusiones (cap\'itulo~\ref{cap:conclusiones}) y el trabajo futuro
(cap\'itulo~\ref{cap:trabajo-futuro}), dependen directamente de esos
aportes y por eso se marcan expl\'icitamente como pendientes de
integraci\'on en lugar de contener contenido definitivo o de relleno.

Los cap\'itulos~\ref{cap:presentacion-pfc}, \ref{cap:mvc-api-rest}
y~\ref{cap:resultados} s\'i contienen contenido inicial redactado a partir
de evidencia real y verificable del repositorio actual de BIOPET (c\'odigo
fuente, README, documentaci\'on de mediciones), sin datos inventados.
