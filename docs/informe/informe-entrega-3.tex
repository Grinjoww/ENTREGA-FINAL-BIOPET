...
\newcommand{\ciudadfecha}{Quevedo, 30 de julio de 2026}
...
% ===========================================================================
\input{secciones/01-resumen-ejecutivo}
\input{secciones/02-estado-sistema}
\input{secciones/03-arquitectura-c4}
\input{secciones/04-trazabilidad}
\input{secciones/05-protocolo-experimental}
\input{secciones/06-resultados-jaime}
\input{secciones/07-resultados-fred}
\input{secciones/08-resultados-zaida}
\input{secciones/09-amenazas-validez}
\input{secciones/10-etica}
\input{secciones/11-credit}
\input{secciones/12-conclusiones}
\input{secciones/13-anexos}
