...
\section{Calidad}
La suite de pruebas del backend (107 pruebas, 0 fallos, 0 errores) y la
...
\begin{itemize}[nosep]
  ...
  \item Renderizar la imagen del diagrama C4 Nivel~3
    (\texttt{c4-componentes-backend.png}) con un renderizador local de
    Graphviz o PlantUML.
