...
REQ-F-001 & Jaime & Registro de usuario (siempre \texttt{ROLE_DUENO}) & \texttt{AuthController}/\texttt{AuthService} & \texttt{AuthControllerTest} & 107 pruebas, 0 fallos & Postman: Registro (due\~no) & Verificado \\
