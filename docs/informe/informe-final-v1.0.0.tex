...
% \commithashcorto: hash corto del commit HEAD real al compilar, tomado de
% docs/informe/commit-info.tex (generado por scripts/gen-informe-commit-info.py,
% mismo mecanismo que la caratula independiente). Asi la fila de la portada
% ("Tag v1.0.0 / commit") coincide siempre con el checkout compilado: tras el
% merge final se mueve v1.0.0 a ese mismo HEAD y no hay hash hardcodeado que
% quede obsoleto. El respaldo de abajo NUNCA debe quedar impreso en un PDF
% final: si aparece, no se ejecuto el script de generacion antes de compilar.
\providecommand{\commitactual}{PENDIENTE-EJECUTAR-scripts/gen-informe-commit-info.py}
\providecommand{\fechaactual}{Quevedo, 18 de agosto de 2026}
\IfFileExists{commit-info.tex}{\input{commit-info.tex}}{}
\newcommand{\commithashcorto}{\commitactual}
