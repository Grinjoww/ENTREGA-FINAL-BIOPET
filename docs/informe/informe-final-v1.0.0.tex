...
\newcommand{\urlrepositorio}{https://github.com/Grinjoww/ENTREGA-FINAL-BIOPET}
...
\begin{titlepage}
  ...
  {\normalsize
    \begin{tabular}{c}
      Mariscal Cabrera Jaime Josu\'e \quad --- \quad jmariscalc@uteq.edu.ec \quad --- \quad ORCID: \orcidjaime \\
      Beltr\'an Montiel Fred Adri\'an \quad --- \quad fbeltranm@uteq.edu.ec \quad --- \quad ORCID: \orcidfred \\
      Taipe Mora Zaida Melissa \quad --- \quad ztaipem@uteq.edu.ec \quad --- \quad ORCID: \orcidzaida \\
    \end{tabular}
    \par
  }
