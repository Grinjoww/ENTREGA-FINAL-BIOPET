...
\texttt{v1.0.0} ya fue creado y publicado, apunta al commit
\texttt{0d5cd52} (2026-08-18) y se conserva inmutable como referencia
hist\'orica del cierre de la Entrega Final; las correcciones posteriores
de retroalimentaci\'on/recalificaci\'on se realizan sobre \texttt{main},
sin mover ese tag. El GitHub Release correspondiente --- artefacto
