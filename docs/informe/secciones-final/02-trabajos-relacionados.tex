...
\texttt{nowicki2022\allowbreak comparative}, \texttt{zuchnik2021\allowbreak comparative},
\texttt{siebyla2020\allowbreak impact}, \texttt{dhalla2021\allowbreak performance},
\texttt{godinho2024\allowbreak performance}, \texttt{zulfa2020\allowbreak caching},
\texttt{yang2021\allowbreak large}, \texttt{ghatrehsamani2020\allowbreak art}), fuera del alcance
...
2026-08-17 en \rutalarga{docs/informe/borradores/zaida/estudios-primarios-zaida.md},
\rutalarga{docs/informe/borradores/jaime/trabajos-relacionados.md} y
\rutalarga{docs/investigacion/handoff-fred-trabajos-relacionados.md}
respectivamente (fuente primaria de cada bloque; el detalle completo,
incluida la tabla de exclusiones, sigue disponible en
\texttt{docs/checklists/prisma2020.md}, sección 4, ítems 6--7, y se
resume en el anexo B, sección~\ref{sec:anexo-prisma-busqueda}).
...
\begin{itemize}[nosep]
  ...
  \item Con el bloque de Fred, el dominio veterinario exacto de BIOPET pasa
    ...
    revisi\'on.
  \item La clasificaci\'on por nivel de impacto de las 41 referencias
    citadas en todo el informe (16/41 de alto impacto, por debajo del
    m\'inimo exigido por la Gu\'ia Final) se documenta en el anexo~G
    (secci\'on~\ref{sec:anexo-referencias-impacto}).
\end{itemize}
