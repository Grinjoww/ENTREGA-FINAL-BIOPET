...
REQ-F-020 & Jaime & Auditor\'ia de operaciones (parcial: solo autenticaci\'on) & \texttt{Authentication\allowbreak AuditService} & \texttt{AuthenticationAuditServiceTest}; \rutalarga{A09-logging.md} & Parcial \\
...
reproducci\'on \'integra de los 38 requisitos est\'a en el anexo~F
