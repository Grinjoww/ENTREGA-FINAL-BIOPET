...
declarados: el tag Git \texttt{v1.0.0} existe y apunta al commit
\texttt{0d5cd52} (se conserva inmutable como referencia hist\'orica del
cierre de la Entrega Final; las correcciones posteriores se realizan sobre
\texttt{main}), pero el GitHub Release correspondiente todav\'ia no ha
