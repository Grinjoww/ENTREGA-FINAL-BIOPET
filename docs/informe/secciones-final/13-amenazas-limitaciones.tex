  ...
  \item \textbf{Tag \texttt{v1.0.0} y GitHub Release: contexto hist\'orico
    ...
    \begin{itemize}[nosep]
      \item \textbf{Tag Git \texttt{v1.0.0}:} ya fue creado y publicado;
        apunta al commit \texttt{0d5cd52} (creado el 2026-08-18). Se
        conserva \textbf{inmutable} como referencia hist\'orica del cierre
        de la Entrega Final; las correcciones posteriores de
        retroalimentaci\'on y recalificaci\'on se realizan sobre
        \texttt{main}, sin mover, borrar ni recrear ese tag.
